...
<?php
        ...
        //echo Yii::getAlias('@kartik/social');
        echo Yii::getAlias('@app/vendor');
        //echo Yii::getAlias('@foo/test/file.php');  // displays: /path/to/foo/test/file.php
        //echo Yii::getAlias('@foo/bar/file.php');   // displays: /path2/bar/file.php
?>
<!--    </div>-->
    ...
    echo FacebookPlugin::widget([
        ...
        'settings' => ['href' => 'http://www.yii2build.com', 'width' => '450']
